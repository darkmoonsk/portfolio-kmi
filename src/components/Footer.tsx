...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/50 bg-white/60 dark:bg-black/60">
      <div className="max-w-6xl mx-auto px-4 py-8 text-sm text-muted-foreground flex flex-wrap flex-col sm:flex-row items-center justify-center sm:justify-between gap-3">
